...
constexpr const int WIN_LENGTH = 5;
...
class DLLEXPORT Connect5GS : public GameState {
 public:
  Connect5GS() { board_.setZero(); }
  Connect5GS(BoardTensor board, int8_t player, int32_t turn)
  ...
  [[nodiscard]] static Connect5GS from_bytes(const std::string& data);
